...
echo "align_3 $BRICKID.$PLATENUMBER.0.0"
cp align_3.rootrc align.rootrc
source alignplate.sh $BRICKID $PLATENUMBER > out/$BRICKID.$PLATENUMBER.0.0.al3.txt
# cp $BRICKFOLDER.0.0.0.align.ps plot_third_align/$BRICKFOLDER.0.0.0.thirdalign.ps