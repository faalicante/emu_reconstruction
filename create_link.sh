...
RAWDATAPATH=/eos/experiment/sndlhc/emulsionData/Napoli/SND/mic2/RUN$RUN\_W$NWALL\_B$NBRICK 
RECODATAPATH=/eos/experiment/sndlhc/emulsionData/emureco_Napoli/RUN$RUN/$BRICKFOLDER
for iplate in $(seq $4 $3)
  do

  RAWPLATEFOLDER="$(printf "P%02d" $(( 10#$iplate )))"
  # RAWPLATEFOLDER="$(printf "P%02d_RESCAN" $(( 10#$iplate )))"
