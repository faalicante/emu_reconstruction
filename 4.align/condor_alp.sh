...
ln -s $EXP_DIR/$PLATEFOLDER/$BRICKID.$PLATENUMBER.0.0.cp.root ./$PLATEFOLDER
ln -s $EXP_DIR/$NEXTFOLDER/$BRICKID.$PLATENEXT.0.0.raw.root ./$NEXTFOLDER
ln -s $EXP_DIR/$NEXTFOLDER/$BRICKID.$PLATENEXT.0.0.cp.root ./$NEXTFOLDER

ln -s $EXP_DIR/scanset.sh .
