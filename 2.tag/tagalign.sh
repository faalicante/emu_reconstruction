...
seq 1 56 | xargs -i -P 15 bash -c 'echo tagalign '$BRICKID'.{}.0.0 && . ./tagalignplate.sh '$BRICKID' {} 1 > /dev/null'
seq 1 56 | xargs -i -P 15 bash -c 'echo tagalign '$BRICKID'.{}.0.0 && . ./tagalignplate.sh '$BRICKID' {} 2 > /dev/null'
seq 1 56 | xargs -i -P 15 bash -c 'echo tagalign '$BRICKID'.{}.0.0 && . ./tagalignplate.sh '$BRICKID' {} 3 > /dev/null'
makescanset -set=$BRICKID.0.0.0 -dz=-1350 -from_plate=57 -to_plate=1 -dzbase=195
